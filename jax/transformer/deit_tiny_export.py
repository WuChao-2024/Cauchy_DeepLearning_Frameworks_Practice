# JAX/Flax DeiT-Tiny 导出 ONNX
# 用法: python deit_tiny_export.py --dataset cifar100 --ckpt_dir ./outputs/.../checkpoints/best --output ./outputs/.../deit_tiny_cifar100.onnx
...
from deit_tiny_train import TrainState, create_train_state
...
def main():
    ...
    try:
        ...
        # eval 模式下 DeiT 返回 (cls+dist)/2 的单个 logits
        def predict(images):
            return state.apply_fn({'params': state.params}, images, training=False)
