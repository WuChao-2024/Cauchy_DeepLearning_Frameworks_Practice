# JAX/Flax MobileNetV2 精度评测，计算 TOP-1 和 TOP-5
# 用法: python mobilenetv2_eval.py --dataset cifar100 --ckpt_dir ./outputs/.../checkpoints/best
