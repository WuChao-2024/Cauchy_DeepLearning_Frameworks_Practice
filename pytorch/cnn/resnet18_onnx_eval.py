# ResNet-18 ONNX 模型评测，计算 TOP-1 和 TOP-5
# 用法: python resnet18_onnx_eval.py --dataset cifar100 --onnx ./outputs/.../resnet18_cifar100.onnx
...
def parse_args():
    ...
    p.add_argument("--onnx",        required=True, help="ONNX 模型文件路径")
