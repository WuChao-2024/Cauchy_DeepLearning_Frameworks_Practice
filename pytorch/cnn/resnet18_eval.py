# ResNet-18 精度评测，计算 TOP-1 和 TOP-5
# 用法: python resnet18_eval.py --dataset cifar100 --weights ./outputs/resnet18_torch_cifar100_float32_xxx/resnet18_best.pth
...
def main():
    ...
    print(f"\n{'='*50}")
    print(f"  ResNet-18 框架评测（PyTorch）")
    print(f"{'='*50}")
