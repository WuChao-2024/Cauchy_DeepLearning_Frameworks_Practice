# MobileNetV2 ONNX 模型评测，计算 TOP-1 和 TOP-5
# 用法: python mobilenetv2_onnx_eval.py --dataset cifar100 --onnx ./outputs/.../mobilenetv2_cifar100.onnx
