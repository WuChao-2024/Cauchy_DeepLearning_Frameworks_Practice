# ViT-Small 精度评测，计算 TOP-1 和 TOP-5
# 用法: python vit_small_eval.py --dataset cifar100 --weights ./outputs/.../vit_small_best.pth
...
def main():
    ...
    model = ViTSmall(num_classes=cfg["num_classes"], input_size=cfg["input_size"])
    ...
    print(f"\n{'='*50}")
    print(f"  ViT-Small 框架评测（PyTorch）")
    print(f"{'='*50}")
